...
const OrderedItem = ({ productID, orderTime, payed, quantity }) => {
  ...
  return (
    <div className="flex items-center p-3 border-b border-gray-100 last:border-0">
      ...
      <div className="ml-4 text-right">
        <p className="font-medium text-gray-900">Payed:<strong> ${parseFloat(payed).toFixed(2)}</strong> <span className='ml-2'> Qty:<strong>{quantity}</strong></span> </p>
